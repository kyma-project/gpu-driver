...
var _ = Describe("GpuDriver Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind GpuDriver")
			err := k8sClient.Get(ctx, typeNamespacedName, gpudriver)
			if err != nil && errors.IsNotFound(err) {
				resource := &gpuv1beta1.GpuDriver{
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance GpuDriver")
